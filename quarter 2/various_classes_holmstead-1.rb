...
colby = Person.new("Colby","Holmstead",31, "Brown","Brown")
puts colby.to_s
colby_old_home = Address.new("3911 122nd St NE","","Marysville","WA", 98271)
puts colby_old_home.to_s
colby_char = Character.new("Colbert","Human",5000, 1000)
puts colby_char.to_s
colby_char.add_weapon("Keyblade")
colby_char.add_clothing("pants")
puts colby_char.to_s
colby_char.drop_weapon("Keyblade")
colby_char.drop_clothing("pants")
puts colby_char.to_s